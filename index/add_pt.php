     ...
     <div class="wrapper-md control" id="add">
	   ...
	   <div class="panel panel-default">
		    <div class="panel-heading font-bold bg-white ">
			   提交课程&nbsp;&nbsp;<a href="add" class="btn btn-xs btn-primary">返回</a>
		     </div>
				...
				<div class="panel-body">
					<form class="form-horizontal devform">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
						    <input  class="layui-input" placeholder="请输入学校名称 可为空"  v-model="userinfo"/> 
						    <br/>
						    <input  class="layui-input"  placeholder="请输入账号" v-model="userinfo2" required/> 
						    <br/>
						    <input  class="layui-input" placeholder="请输入密码" v-model="userinfo3" required/> 
...
var vm=new Vue({
	...
	methods:{
	    get:function(){
	    	...
	    	if(this.cid=='' || this.userinfo2==''|| this.userinfo3==''){
	    		layer.msg("所有项目不能为空");
	    		return false;
	    	}
		    //userinfo=this.userinfo.replace(/\r\n/g, "[br]").replace(/\n/g, "[br]").replace(/\r/g, "[br]"); 
		    userinfo=this.userinfo;
		    userinfo2=this.userinfo2;
		    userinfo3=this.userinfo3;
		    if(userinfo == ""){
		        userinfo =1
		    }
	   	   ...
	   	   // for(var i=0;i<userinfo.length;i++){	
	   	    	//info=userinfo[i]
	   	    	info = userinfo+" "+userinfo2+" "+userinfo3
	   	    	console.log(info)
