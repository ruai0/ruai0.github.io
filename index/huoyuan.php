  ...
  <div class="lyear-layout-content" role="main">
     <div class="app-content-body ">
	    ...
	    <div class="panel panel-default" >
		    <div class="panel-heading font-bold bg-white">平台列表(这里乱添加会出问题)&nbsp;<button class="btn btn-xs btn-success" data-toggle="modal" data-target="#modal-add">添加</button>
		    <font style="color:red">(有什么问题不懂的，首先看教程，问题解决不了，用二级域名重新搭建一套，对比找出问题，保证程序没问题，且大部分开源！！！脑筋会转弯，问题解决快。)</font></div>
